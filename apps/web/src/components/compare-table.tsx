...
import { categoryLabel, formatObservedAt, priceDisplayLabel, titleCase } from "@/lib/presentation";
...
const rows: ReadonlyArray<{ label: string; render: (agent: Agent) => ReactNode }> = [
  ...
  { label: "Price", render: (a) => <><strong>{priceDisplayLabel(a.pricing.label)}</strong><p>{priceDisplayLabel(a.pricing.explanation)}</p></> },
