      ...
      <div className="detail-sections">
        ...
        <section className="detail-section">
          ...
          <div className="detail-section__body">
            ...
            <div className="detail-kv"><span>Uptime window</span><span>{agent.metrics.uptime.windowSeconds === null ? "Not observed" : `${Math.round(agent.metrics.uptime.windowSeconds / 60)} min · ${formatObservedAt(agent.metrics.uptime.observedFrom)} to ${formatObservedAt(agent.metrics.uptime.observedTo)}`}</span></div>
