...
export type IngestionErrorCode =
  ...
  | "REGISTRY_SYNC_CONFIG_INVALID"
  | "REGISTRY_SYNC_RANGE_EXCEEDED"
  | "REGISTRY_SYNC_EVENT_LIMIT_EXCEEDED"
  | "REGISTRY_FINALITY_UNRESOLVED"
  | "REGISTRY_READER_NOT_CONFIGURED"
  | "REPUTATION_SYNC_CONFIG_INVALID"
  | "REPUTATION_SYNC_RANGE_EXCEEDED"
  | "REPUTATION_SYNC_EVENT_LIMIT_EXCEEDED"
  | "REPUTATION_FINALITY_UNRESOLVED"
  | "REPUTATION_READER_NOT_CONFIGURED"
  | "REPUTATION_DUPLICATE_CONFLICT"
  | "REPUTATION_CHECKPOINT_CONFLICT"
  | "REPUTATION_IDENTITY_NOT_FOUND"
