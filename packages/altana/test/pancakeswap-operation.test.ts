...
test("builds only the pinned exact PancakeSwap V2 testnet swap", () => {
  const result = buildBoundedPancakeSwap({ policy: policy(), wallet, quotedOut: 1_000n, quotedAtUnix: 1_700_000_000, quoteBlock: 1n, nowUnix: 1_700_000_000, deadlineUnix: 1_700_000_120 });
...
test("fails closed for stale quotes, excessive deadline, wrong router/selector, or insufficient cap", () => {
  const input = { wallet, quotedOut: 1_000n, quotedAtUnix: 1_700_000_000, quoteBlock: 1n, nowUnix: 1_700_000_000, deadlineUnix: 1_700_000_121 };
