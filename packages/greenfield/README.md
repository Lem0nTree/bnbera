...
The `EvidencePublisher` accepts injected IPFS and Greenfield adapters. Each
provider has its own idempotency key, state, locator, and verification result,
...
credential references are pinned in `config/standards.lock.json`.
